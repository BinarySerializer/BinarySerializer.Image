...
namespace BinarySerializer.Image
{
    public class DDS_PixelFormat : BinarySerializable
    {
        ...
        public override void SerializeImpl(SerializerObject s)
        {
            ...
            if (StructSize != 32)
                throw new BinarySerializableException(this, $"Invalid DDS pixel format struct size of {StructSize}. Should be 32.");
        ...
        public static DDS_PixelFormat GetDefaultPixelFormat(DDS_Parser.PixelFormat format) {
            var fmt = format switch
            {
                DDS_Parser.PixelFormat.RGBA => DdsPfA8R8G8B8(),
                DDS_Parser.PixelFormat.RGB => DdsPfR8G8B8(),
                DDS_Parser.PixelFormat.DXT1 => DdsPfDx("DXT1"),
                DDS_Parser.PixelFormat.DXT2 => DdsPfDx("DXT2"),
                DDS_Parser.PixelFormat.DXT3 => DdsPfDx("DXT3"),
                DDS_Parser.PixelFormat.DXT4 => DdsPfDx("DXT4"),
                DDS_Parser.PixelFormat.DXT5 => DdsPfDx("DXT5"),
                DDS_Parser.PixelFormat.DXT5n => DdsPfDx("DXT5", true),
                DDS_Parser.PixelFormat.THREEDC => DdsATI2(),
                DDS_Parser.PixelFormat.LUMINANCE => DdsLuminance(),
